...
namespace Rassef.Migrations
{
    ...
    [Migration("20260918200557_Add_Caller")]
    partial class Add_Caller
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rassef.Models.Entities.QueueTicket", b =>
                {
                    ...
                    b.HasIndex("TicketStatusId", "DepartmentId", "QueueTime");
            ...
            modelBuilder.Entity("Rassef.Models.Entities.SupplierRequest", b =>
                {
                    ...
                    b.HasIndex("RequestStatusId", "DepartmentId", "CreatedAT");
            ...
            modelBuilder.Entity("Rassef.Models.Entities.Truck", b =>
                {
                    ...
                    b.HasIndex("PlateNumber", "PlateLetter")
                        .IsUnique();
            ...
            modelBuilder.Entity("Rassef.Models.Identity.User", b =>
                {
                    ...
                    b.Property<int?>("LastPickedWarehouseId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LastPickedWarehouseId");
            ...
            modelBuilder.Entity("Rassef.Models.Identity.UserWarehouse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rassef.Models.StatusesAndActions.DepartmentTypes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rassef.Models.StatusesAndActions.DriverTypes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rassef.Models.Entities.Department", b =>
                {
                    ...
                    b.HasOne("Rassef.Models.StatusesAndActions.DepartmentTypes", "DepartmentType")
            ...
            modelBuilder.Entity("Rassef.Models.Entities.Driver", b =>
                {
                    ...
                    b.HasOne("Rassef.Models.StatusesAndActions.DriverTypes", "DeiverType")
                        .WithMany("Drivers")
            ...
            modelBuilder.Entity("Rassef.Models.Entities.SupplierRequest", b =>
                {
                    b.HasOne("Rassef.Models.Identity.User", "Caller")
                        .WithMany()
            ...
            modelBuilder.Entity("Rassef.Models.Identity.User", b =>
                {
                    ...
                    b.HasOne("Rassef.Models.Entities.Warehouse", "LastPickedWarehouse")
                        .WithMany()
                        .HasForeignKey("LastPickedWarehouseId");
                    ...
                    b.Navigation("LastPickedWarehouse");
            ...
            modelBuilder.Entity("Rassef.Models.Identity.UserWarehouse", b =>
                {
                    b.HasOne("Rassef.Models.Identity.User", "User")
